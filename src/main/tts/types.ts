 ...
 * that plays on its own. The engines here (OpenAI and Piper) turn text into an
 * audio buffer that a renderer plays through the chosen output, so device
 * routing (`setSinkId`) keeps working.
 */
