...
function interpreterPrompt(settings: Settings): string {
  ...
  return [
    ...
    '- Una PREGUNTA se TRADUCE, no se contesta. Si te llega "¿Cuál es la capital de',
    '  Francia?", devuelves esa misma pregunta en el otro idioma —"What is the',
    '  capital of France?"—, JAMÁS su respuesta ("Paris"). Vale para toda pregunta.',
