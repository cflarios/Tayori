...
export const en = {
  ...
  'overlay.ttsPlay': 'Read aloud',
  'overlay.ttsStop': 'Stop reading',
  ...
  'beh.profile': 'Active profile',
  'beh.profileDesc': 'Adapts the tone and the structure to the kind of meeting.',
  'beh.cardTrigger': 'When it answers',
  'beh.cardTriggerHint':
    'The trigger, and nothing else. Ctrl+Enter always asks by hand, in every mode.',
  'beh.cardWindow': 'Listening window',
  'beh.cardWindowHint':
    'How long it keeps listening, and how much of the transcript rides with every question.',
  'beh.cardVoice': 'How answers read',
  'beh.cardVoiceHint':
    'The profile decides the shape of an answer; the languages decide the words it is written in.',
  'beh.cardScreen': 'Screen mode',
  'beh.cardScreenHint':
    'What happens when you solve what is on the screen instead of what you hear.',
  ...
  'beh.profListHint':
    'Each one is a way of answering, with the context it reads. Hide the ones you never use and the overlay picker stops offering them.',
  'beh.profActive': 'Active',
  'beh.profUse': 'Use',
  'beh.profEdited': 'Edited',
  'beh.profDuplicate': 'Duplicate',
  'beh.profShown': 'Shown in the overlay picker',
  'beh.profHiddenTitle': 'Hidden from the overlay picker',
  'beh.profExpand': 'Show the prompt',
  'beh.profSystemPrompt': 'System prompt',
  'beh.profPromptHint': 'Sent ahead of every answer while this profile is active.',
  'beh.profRemovedCount': 'Removed ({count})',
  'beh.profCopy': '{name} copy',
  'beh.profUntitled': 'Untitled profile',
  ...
  'aud.testing': 'Playing…',
  'tts.title': 'Spoken answers',
  'tts.hint': 'Read the assistant’s answers aloud. Free and offline with the system voices, or a cloud engine for a more natural voice.',
  'tts.enable': 'Read answers aloud',
  'tts.enableHint': 'Master switch. Off means no reading and no speak buttons.',
  'tts.provider': 'Engine',
  'tts.providerHint': 'Which engine turns the answer into speech.',
  'tts.webspeech': 'System voices (offline)',
  ...
  'tts.voice': 'Voice',
  'tts.voiceDefault': 'Default',
  'tts.rate': 'Speed',
  'tts.autoRead': 'Read new answers automatically',
  'tts.autoReadHint': 'With this off, use the speak button on the answers you choose.',
  'tts.test': 'Test voice',
  'tts.testing': 'Playing…',
  'tts.sample': 'This is how the answers will sound.',
  'tts.err.noOpenaiKey': 'OpenAI text-to-speech needs the OpenAI API key.',
  'tts.err.openaiRequest': 'OpenAI speech failed ({status}). {detail}',
  'tts.piperNote': 'Local neural voices — offline and honoring the output device. Each voice downloads a small model once.',
  'tts.piperNotInstalled': 'download',
  'tts.installVoice': 'Download voice ({size} MB)',
  'tts.installing': 'Downloading…',
  'tts.installingPct': 'Downloading… {pct}%',
  'tts.err.piperDownload': 'Couldn’t download {url}: HTTP {status}.',
  'tts.err.piperUnzip': 'Couldn’t unpack Piper: {detail}',
  'tts.err.piperNoExe': 'The Piper executable isn’t installed yet.',
  'tts.err.piperUnknownVoice': 'Unknown Piper voice: {id}.',
  'tts.err.piperNoVoice': 'Download a Piper voice first.',
  'tts.err.piperRun': 'Piper failed: {detail}',
  'aud.inertWarn':
