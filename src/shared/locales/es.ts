...
export const es: Record<UIKey, string> = {
  ...
  'beh.profile': 'Perfil activo',
  'beh.profileDesc': 'Adapta el tono y la estructura al tipo de reunión.',
  'beh.cardTrigger': 'Cuándo responde',
  'beh.cardTriggerHint':
    'El disparo, y nada más. Ctrl+Enter pregunta a mano siempre, en cualquier modo.',
  'beh.cardWindow': 'Ventana de escucha',
  'beh.cardWindowHint':
    'Cuánto tiempo sigue escuchando, y cuánta transcripción acompaña a cada pregunta.',
  'beh.cardVoice': 'Cómo se leen las respuestas',
  'beh.cardVoiceHint':
    'El perfil decide la forma de la respuesta; los idiomas deciden en qué palabras se escribe.',
  'beh.cardScreen': 'Modo pantalla',
  'beh.cardScreenHint':
    'Qué pasa cuando resuelves lo que hay en la pantalla en vez de lo que oyes.',
  ...
  'beh.profListHint':
    'Cada uno es una manera de responder, con el contexto que lee. Oculta los que no uses y el selector del overlay deja de ofrecerlos.',
  'beh.profActive': 'Activo',
  'beh.profUse': 'Usar',
  'beh.profEdited': 'Editado',
  'beh.profDuplicate': 'Duplicar',
  'beh.profShown': 'Se muestra en el selector del overlay',
  'beh.profHiddenTitle': 'Oculto en el selector del overlay',
  'beh.profExpand': 'Ver el prompt',
  'beh.profSystemPrompt': 'Prompt de sistema',
  'beh.profPromptHint': 'Se envía antes de cada respuesta mientras este perfil esté activo.',
  'beh.profRemovedCount': 'Quitados ({count})',
  'beh.profCopy': '{name} copia',
  'beh.profUntitled': 'Perfil sin nombre',
  ...
  'tts.piperNote': 'Voces neuronales locales — offline y respetando el dispositivo de salida. Cada voz descarga un modelo pequeño una vez.',
  'tts.piperNotInstalled': 'descargar',
  'tts.installVoice': 'Descargar voz ({size} MB)',
  'tts.installing': 'Descargando…',
  'tts.installingPct': 'Descargando… {pct}%',
  'tts.err.piperDownload': 'No se pudo descargar {url}: HTTP {status}.',
  'tts.err.piperUnzip': 'No se pudo descomprimir Piper: {detail}',
  'tts.err.piperNoExe': 'El ejecutable de Piper aún no está instalado.',
  'tts.err.piperUnknownVoice': 'Voz de Piper desconocida: {id}.',
  'tts.err.piperNoVoice': 'Descarga primero una voz de Piper.',
  'tts.err.piperRun': 'Piper falló: {detail}',
  'aud.inertWarn':
